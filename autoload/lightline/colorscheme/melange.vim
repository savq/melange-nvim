...
let s:p.insert.left     = [[[s:grays.float, 0], [s:bright.yellow, 0]], [[s:grays.com, 0], [s:grays.float, 0]]]
let s:p.insert.right    = [[[s:grays.float, 0], [s:bright.yellow, 0]], [[s:grays.float, 0], [s:normal.yellow, 0]]]

let s:p.replace.left    = [[[s:grays.bg, 0], [s:bright.red, 0]], [[s:grays.com, 0], [s:grays.float, 0]]]
let s:p.replace.right   = [[[s:grays.bg, 0], [s:bright.red, 0]], [[s:grays.float, 0], [s:normal.red, 0]]]
