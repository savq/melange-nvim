...
highlight NormalFloat guifg=#E4DED8 guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight NormalNC guifg=#E4DED8 guibg=#272420 guisp=NONE gui=NONE blend=NONE
highlight Comment guifg=#A28C76 guibg=NONE guisp=NONE gui=italic blend=NONE
highlight Conceal guifg=#FFCC66 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight Whitespace guifg=#73614E guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight! link NonText Whitespace
highlight! link SpecialKey Whitespace
highlight Cursor guifg=#2A2622 guibg=#E4DED8 guisp=NONE gui=NONE blend=NONE
highlight TermCursor guifg=#2A2622 guibg=#E4DED8 guisp=NONE gui=NONE blend=NONE
highlight CursorColumn guifg=NONE guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight! link CursorLine CursorColumn
highlight LineNr guifg=#86705B guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight Folded guifg=#A28C76 guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight! link FoldColumn LineNr
highlight Pmenu guifg=NONE guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight PmenuSel guifg=NONE guibg=#73614E guisp=NONE gui=NONE blend=NONE
...
highlight StatusLine guifg=NONE guibg=#413B35 guisp=NONE gui=NONE blend=NONE
highlight StatusLineNC guifg=#86705B guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight TabLine guifg=#A28C76 guibg=#413B35 guisp=NONE gui=NONE blend=NONE
highlight TabLineFill guifg=NONE guibg=#35302C guisp=NONE gui=NONE blend=NONE
highlight TabLineSel guifg=NONE guibg=#73614E guisp=NONE gui=NONE blend=NONE
highlight Search guifg=#2A2622 guibg=#FFCC66 guisp=NONE gui=NONE blend=NONE
highlight! link IncSearch Search
highlight! link Substitute Search
highlight Visual guifg=NONE guibg=#413B35 guisp=NONE gui=NONE blend=NONE
highlight VisualNOS guifg=NONE guibg=#413B35 guisp=NONE gui=NONE blend=NONE
highlight ModeMsg guifg=#86705B guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight Identifier guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight Ignore guifg=#86705B guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight TSField guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight! link TSProperty TSField
highlight TSParameter guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight! link TSParameterReference TSParameter
highlight TSVariable guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight TSVariableBuiltin guifg=#E4DED8 guibg=NONE guisp=NONE gui=italic blend=NONE
...
highlight TSText guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight TSEmphasis guifg=#E4DED8 guibg=NONE guisp=NONE gui=italic blend=NONE
highlight TSUnderline guifg=#E4DED8 guibg=NONE guisp=NONE gui=underline blend=NONE
highlight TSStrike guifg=#A28C76 guibg=NONE guisp=NONE gui=underline blend=NONE
highlight markdownLinkText guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight TSStrong guifg=#E4DED8 guibg=NONE guisp=NONE gui=bold blend=NONE
...
highlight MatchParen guifg=#F9F7F6 guibg=#73614E guisp=NONE gui=NONE blend=NONE
highlight Constant guifg=#997AB8 guibg=NONE guisp=NONE gui=NONE blend=NONE
highlight LspDiagnosticsDefaultInformation guifg=#E4DED8 guibg=NONE guisp=NONE gui=NONE blend=NONE
...
highlight Normal guifg=#E4DED8 guibg=#2A2622 guisp=NONE gui=NONE blend=NONE