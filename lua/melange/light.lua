...
-- Color palette
local red     = hsl(350, 60, 40)
local salmon  = hsl( 10, 90, 40)
local orange  = hsl( 30, 90, 40)
local amber   = hsl( 40, 60, 50)
local yellow  = hsl( 40, 90, 40)

local green   = hsl(100, 40, 40)
local teal    = hsl(150, 40, 30)
local cyan    = hsl(180, 20, 40)

local blue    = hsl(225, 30, 50)
local purple  = hsl(270, 30, 40)
local magenta = hsl(310, 40, 50)
